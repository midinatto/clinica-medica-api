...
import br.edu.imepac.central.services.FuncionarioService;
...
public class FuncionarioAgenController {
    private final FuncionarioService funcionarioService;

    public FuncionarioAgenController(FuncionarioService funcionarioService) {
